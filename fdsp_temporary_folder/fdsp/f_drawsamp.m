function f_drawsamp (h,colors,fsize)

%F_DRAWSAMP: Draw a block diagram for GUI module g_sample
%
% Usage: f_drawsamp (h,colors,fsize);
%
% Inputs: 
%         h      = axes handle
...
text (0.5-1.5*arrow-boxwidth-0.03,y0,'x_a','Color',colors(1,:),'HorizontalAlignment','center',...
...
text (0.5-0.5*arrow-0.5*boxwidth,y0+0.25*boxheight,'Anti-','HorizontalAlignment','center',...
      'FontName','FixedWidthFontName','FontSize',fsize)
text (0.5-0.5*arrow-0.5*boxwidth,y0,'aliasing','HorizontalAlignment','center',...
      'FontName','FixedWidthFontName','FontSize',fsize)
