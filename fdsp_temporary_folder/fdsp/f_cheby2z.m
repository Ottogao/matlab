...
%              polynomial
%
% See also: F_BUTTERZ, F_CHEBY1Z, F_ELLIPTICZ
...
F_0 = r*F_1;
if nargin < 7
   [bs,as] = f_cheby2s (F_0,F_1,delta_p,delta_s);
else
   [bs,as] = f_cheby2s (F_0,F_1,delta_p,delta_s,n);
end
...
case 0, [B,A] = f_low2lows  (bs,as,F_s);
case 1, [B,A] = f_low2highs (bs,as,F_s);
case 2, [B,A] = f_low2bps   (bs,as,F_s(1),F_s(2));
case 3, [B,A] = f_low2bss   (bs,as,F_s(1),F_s(2));
