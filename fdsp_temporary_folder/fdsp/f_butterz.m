function [b,a] = f_butterz (F_p,F_s,delta_p,delta_s,ftype,fs,n)

%F_BUTTERZ: Design a Butterworth IIR digital filter
%
% Usage: [b,a] = f_butterz (F_p,F_s,delta_p,delta_s,ftype,...
%                          fs,n)
%
% Inputs: 
...
%              polynomial
%
% See also: F_CHEBY1Z, F_CHEBY2Z, F_ELLIPTICZ
...
F_1 = F_0/r;
if nargin < 7
   [bs,as] = f_butters (F_0,F_1,delta_p,delta_s);
else
   [bs,as] = f_butters (F_0,F_1,delta_p,delta_s,n);
end
...
% Convert to desired frequency-selective filter
