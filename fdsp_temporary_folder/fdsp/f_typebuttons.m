function [hc_type,userinput] = f_typebuttons (pos,nt,xm,labels,fcolor,bcolor,cback,userinput,tipstrs,ns,fsize)

%F_TYPEBUTTONS: Create radio buttons for type options
%
% Usage: [hc_type,userinput] = f_typebuttons (pos,nt,xm,labels,fcolor,bcolor,cback,userinput,tipstrs,ns,fsize);
%
% Inputs: 
