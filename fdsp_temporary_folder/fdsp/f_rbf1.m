function y = f_rbf1 (x,w,V,a,b,m,n,d)

% F_RBF1: Compute output of first order raised-cosine RBF network
%
% Usage: y = f_rbf1 (x,w,V,a,b,m,n,d)
%
% Inputs: 
...
for k = 1 : N
    ...
    for j = 1 : M
        ...
        y(k) = y(k) + (w(s) + V(s,:)*(theta-Vert(:,j)))*z;
    end
end
close(h)
