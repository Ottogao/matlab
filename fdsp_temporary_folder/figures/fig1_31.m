...
% FIGURE 1.31: Magnitude spectra of DAC input and output

clc
clear
fprintf ('Figure 1.31: Magnitude spectra of DAC input and output\n\n')
B = 100;
fs = 2*B;
T = 1/fs;
f_d = fs/2;
...
f_labels ('DAC magnitude spectra','{\itf} (Hz)','|{\itY_a^{\ast}(f)}|')
