...
f0 = 10;     % starting subcarrier frequency
...
st = st+10*randn(1,length(st));    % optional Gaussian noise
...
% please compare bk and rbk, for errors, and display the number of errors
